...
class Square():
    """
        Square information
        Example:
        (1, "Mediterranean Avenue", 60, 2, "Brown", True, None)
        (5, "Income Tax", None, None, None, False, -200)
    """
    def __init__(self, position, name, cost, rent, neighborhood, action):
        ...
        # Standard rent (no houses)
        self.rent = rent

        # Neighborhood
        self.neighborhood = neighborhood

        # Effect on wealth (if square is Go or Tax)
        self.action = action

        # Define who owns property
        self.ownedBy = None
